...
Try {
	...
	[string]$appVendor = 'Seterra'
	[string]$appName = 'Sebran'
	[string]$appVersion = '1.49'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '7/19/2016'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-Process -Path 'sebran.exe' -Parameters '/SILENT'
        ...
        Execute-Process -Path "${env:ProgramFiles(x86)}\Sebran\unins000.exe" -Parameters '/silent /silentnoreboot'

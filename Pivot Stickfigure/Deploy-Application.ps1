...
Try {
	...
	[string]$appVendor = 'Pivot Animator'
	[string]$appName = 'Pivot Stickfigure'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-Process -Path "${env:ProgramFiles(x86)}\Pivot Animator\unins000.exe" -Parameters '/VERYSILENT /SUPPRESSMSGBOXES /NORESTART /SP-'

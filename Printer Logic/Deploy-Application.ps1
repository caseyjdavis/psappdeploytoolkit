...
Try {
	...
	[string]$appVendor = 'Printer Logic'
	[string]$appName = 'PrintClient'
	[string]$appVersion = '15.1.5.227'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-MSI -Action Install -Path 'PrinterInstallerClient.msi' -AddParameters 'HOMEURL=http://printers.psdschools.org' #// Only needed if you have more to pass to the MSI besides /qb and norestart
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        #Show-InstallationProgress -StatusMessage 'Uninstalling < > ...'
        #Write-Log -Message 'Uninstalling < > ...'
        ...
        Execute-MSI -Action Uninstall -Path 'PrinterInstallerClient.msi'

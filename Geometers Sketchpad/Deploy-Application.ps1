...
Try {
	...
	[string]$appVendor = 'KCP Technologies'
	[string]$appName = 'Geometers Sketchpad'
	[string]$appVersion = '4.07'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-MSI -Action Install -Path 'ManageGSP407.msi' ## Uncomment if you need parameters -AddParameters ## if you have more to pass to the MSI besides /qb and norestart
        ...
        Execute-MSI -Action Uninstall -Path 'ManageGSP407.msi'

...
Try {
	...
	[string]$appVendor = 'MIT'
	[string]$appName = 'Scratch'
	[string]$appVersion = '4.47'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-Process -Path 'Install Scratch 2.exe' -Parameters '-silent -desktopShortcut -programMenu -allowDownload'
        ...
        Execute-MSI -Action Uninstall -Path 'setup.msi'

...
Try {
	...
	[string]$appVersion = '7.1.5.1557'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '7/12/2016'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Show-InstallationProgress -StatusMessage "Installing Google Earth ..."
        Write-Log -Message "Installing Google Earth ..."
        Execute-Process -Path 'GoogleEarthWin.exe'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        #// Uninstalls the < >
        Show-InstallationProgress -StatusMessage "Uninstalling Google Earth ..."
        Write-Log -Message "Uninstalling Google Earth ..."
        Execute-MSI -Action Uninstall -Path '{817750FA-EC6A-485D-9901-0683AE6FFDF1}'

...
Try {
	...
	[string]$appVendor = 'DonJonhston Inc'
	[string]$appName = 'Snap&Read'
	[string]$appVersion = '1.00.1000'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '7/11/2016'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-MSI -Action Install -Path 'SnapRead.msi' ## Uncomment if you need parameters -AddParameters ## if you have more to pass to the MSI besides /qb and norestart
        ...
        Execute-MSI -Action Uninstall -Path 'SnapRead.msi'

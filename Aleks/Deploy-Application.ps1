...
Try {
	...
	[string]$appVendor = 'McGraw Hill'
	[string]$appName = 'Aleks'
	[string]$appVersion = '3.18'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-MSI -Action Install -Path 'aleks318.msi' ## Uncomment if you need parameters -AddParameters ## if you have more to pass to the MSI besides /qb and norestart
        ...
        Execute-MSI -Action Uninstall -Path 'aleks318.msi'

...
Try {
	...
	[string]$appVendor = 'Sunburst Digital'
	[string]$appName = 'Type to Learn 4'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-MSI -Action Install -Path 'TTL4_1_2_windows.msi' ## Uncomment if you need parameters -AddParameters ## if you have more to pass to the MSI besides /qb and norestart
        ...
        Execute-MSI -Action Uninstall -Path 'TTL4_1_2_windows.msi'

...
Try {
	...
	[string]$appVendor = 'Lexia Learning Systems Inc'
	[string]$appName = 'Lexia Core'
	[string]$appVersion = '5-1.2.1.249'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '7/18/2016'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-MSI -Action Install -Path 'LexiaCore5-1.2.1.249-us.msi' ## Uncomment if you need parameters -AddParameters ## if you have more to pass to the MSI besides /qb and norestart
        ...
        Execute-MSI -Action Uninstall -Path 'LexiaCore5-1.2.1.249-us.msi'

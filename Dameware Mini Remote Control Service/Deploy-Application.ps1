...
Try {
	...
	[string]$appVendor = 'Solarwinds'
	[string]$appName = 'Dameware Mini Remote Control Service'
	[string]$appVersion = '11.2.0.0'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Show-InstallationProgress -StatusMessage "Installing $appVendor $appName $appVersion ..."
        Write-Log -Message "Installing $appVendor $appName $appVersion ..."
        Execute-MSI -Action Install -Path 'PSDDamewareClient.msi' #-AddParameters #// Only needed if you have more to pass to the MSI besides /qb and norestart
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'DWRCS.exe' -CloseAppsCountdown 60 #// Specify the process name of any app or apps (seperated by a comma) that you would like to be closed before this app is uninstalled
        ...
        Show-InstallationProgress -StatusMessage "Uninstalling $appVendor $appName $appVersion ..."
        Write-Log -Message "Uninstalling $appVendor $appName $appVersion ..."
        Execute-MSI -Action Uninstall -Path 'PSDDamewareClient.msi'

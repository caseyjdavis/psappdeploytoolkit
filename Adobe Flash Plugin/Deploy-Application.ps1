...
Try {
	...
	[string]$appName = 'Flash Plugin'
	[string]$appVersion = '22.0.0.194'
	[string]$appArch = 'x86/x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '07/06/16'
	[string]$appScriptAuthor = 'mvaldez'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Show-InstallationProgress -StatusMessage 'Installing Adobe Flash Plugin ...'
        Write-Log -Message 'Installing Adobe Flash Plugin'
        ...
        Write-Log -Message 'Copying Adobe Flash mms.cfg file'
        Copy-Item $scriptDirectory\supportfiles\mms.cfg -Destination C:\WINDOWS\SysWOW64\Macromed\Flash
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		If(Test-Path C:\WINDOWS\SysWOW64\Macromed\Flash\mms.cfg){Remove-Item C:\WINDOWS\SysWOW64\Macromed\Flash\mms.cfg}
        ...
        #// Uninstalls the < >
        Show-InstallationProgress -StatusMessage 'Uninstalling the Adobe Flash Plugin ...'
        Write-Log -Message 'Uninstalling the Adobe Flash Plugin ...'
        Execute-MSI -Action Uninstall -Path 'install_flash_player_22_plugin.msi'

...
Try {
	...
	[string]$appName = 'Local Administrator Password Solution (LAPS)'
	[string]$appVersion = '6.1'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0'
	[string]$appScriptDate = '7/5/2016'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        #// Installs the Lapsx64.msi located in the Files directory
        Show-InstallationProgress -StatusMessage 'Installing LAPS 6.1...'
        Write-Log -Message 'Installing LAPS x64 6.1'
        Execute-MSI -Action Install -Path 'LAPS.x64.msi'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        #// Uninstalls LAPS using the LAPS.x64.msi in the Files directory
        Show-InstallationProgress -StatusMessage 'Uninstalling LAPS...'
        Write-Log -Message 'Uninstalling LAPS'
        Execute-MSI -Action Uninstall -Path 'LAPS.x64.msi'

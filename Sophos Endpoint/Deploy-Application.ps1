...
Try {
	...
	[string]$appVendor = 'Sophos'
	[string]$appName = 'Endpoint'
	[string]$appVersion = '4.65.0.0'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-Process -Path 'SophosEndpoint2016.exe'
        ...
        Write-Log "Pausing for 5 minutes to allow Sophos client to update and checkin"; Start-Sleep -Seconds 600

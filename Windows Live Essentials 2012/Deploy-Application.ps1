...
Try {
	...
	[string]$appName = 'Windows Live Essentials 2012'
	[string]$appVersion = '16.4.3508.0205'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-Process -Path 'wlsetup-all.exe' -Parameters '/q /NoLaunch /NoCEIP /NoToolbarCEIP /NoHomepage /NoMU /NoSearch /AppSelect:PhotoGallery /AppSelect:MovieMaker'
        ...
        Execute-Process -Path "${env:ProgramFiles(x86)}\Windows Live\Installer\wlarp.exe" -Parameters '/cleanup:all /q'

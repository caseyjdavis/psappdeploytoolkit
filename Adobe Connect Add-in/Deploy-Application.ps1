...
Try {
	...
	[string]$appName = 'Connect Addin'
	[string]$appVersion = '11.9.976.291'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0'
	[string]$appScriptDate = '7/14/2016'
	[string]$appScriptAuthor = 'George Sandez'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        #// Installs the AdobeConnectAddinInstaller.exe located in the Files directory
        ...
        Execute-Process -Path 'AdobeConnectAddinInstaller.exe' -Parameters '/SP- /VERYSILENT /CLOSEAPPLICATIONS'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'iexplore,firefox,chrome' -CloseAppsCountdown 60 #// Specify the process name of any app or apps (seperated by a comma) that you would like to be closed before this app is uninstalled
        ...
        #// Uninstalls the Adobe Connect using the Uninstall.exe located in the Files directory - Pulled from appdata folder!
        ...
        if (Test-Path "${env:APPDATA}\Macromedia\Flash Player\www.macromedia.com\bin\adobeconnectaddin\unins000.exe"){
        Execute-Process -Path "${env:APPDATA}\Macromedia\Flash Player\www.macromedia.com\bin\adobeconnectaddin\unins000.exe" -Parameters '/VERYSILENT'}

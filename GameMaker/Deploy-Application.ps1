...
Try {
	...
	[string]$appVendor = 'YoYo Games Ltd'
	[string]$appName = 'GameMaker'
	[string]$appVersion = '8.1.141'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-Process -Path 'GameMaker-Installer-8-1-141.exe' -Parameters '/S'
        ...
        Execute-Process -Path "${env:UserProfile}\GameMaker 8.1\uninstall.exe" -Parameters '/S'
